...
async function boot(){
 ...
 tg.ready();tg.expand();me=await api('/api/me');$('role').textContent=me.role;$('login').hidden=true;$('workspace').hidden=false;$('add').hidden=me.role==='producer';$('analytics').hidden=me.role==='lead_collector';
